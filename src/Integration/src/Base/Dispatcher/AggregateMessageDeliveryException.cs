...
namespace Steeltoe.Integration.Dispatcher
{
    ...
    {
        private readonly List<Exception> aggregatedExceptions;
        ...
        {
            get { return new List<Exception>(this.aggregatedExceptions); }
        }
        ...
        public override string Message
        {
            get
            {
                ...
                foreach (Exception exception in this.aggregatedExceptions)
                {
