...
namespace Steeltoe.Integration.Support
{
    public class MutableMessageHeaders : MessageHeaders
    {
        ...
        public override object this[string key] { get => this.headers[key]; set => this.headers[key] = value; }
        ...
        private static Guid? ExtractId(IDictionary<string, object> headers)
        {
            ...
            {
                object id = headers[MessageHeaders.ID];
                if (id is string)
                {
        ...
        private static long? ExtractTimestamp(IDictionary<string, object> headers)
        {
            ...
            {
                object timestamp = headers[MessageHeaders.TIMESTAMP];
