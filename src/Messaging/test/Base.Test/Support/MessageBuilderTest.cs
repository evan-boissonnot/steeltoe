...
namespace Steeltoe.Messaging.Test.Support
{
    public class MessageBuilderTest
    {
        ...
        {
            IMessage<string> message = MessageBuilder<string>.WithPayload("foo").Build();
        ...
        {
            IMessage<string> message = MessageBuilder<string>.WithPayload("test")
                    .SetHeader("foo", "bar")
                    .SetHeader("count", 123)
                    .Build();
        ...
        {
            IMessage<string> message1 = MessageBuilder<string>.WithPayload("test1")
                    .SetHeader("foo", "1")
                    .SetHeader("bar", "2")
                    .Build();
            IMessage<string> message2 = MessageBuilder<string>.WithPayload("test2")
        ...
        {
            IMessage<string> message1 = MessageBuilder<string>.WithPayload("test")
                    .SetHeader("foo", "bar").Build();
            IMessage<string> message2 = MessageBuilder<string>.FromMessage(message1).Build();
        ...
        public void CreateIdRegenerated()
        {
            IMessage<string> message1 = MessageBuilder<string>.WithPayload("test")
                    .SetHeader("foo", "bar").Build();
            IMessage<string> message2 = MessageBuilder<string>.FromMessage(message1).SetHeader("another", 1).Build();
            Assert.Equal("bar", message2.Headers.Get<string>("foo"));
        ...
        {
            IMessage<int> message1 = MessageBuilder<int>.WithPayload(1)
                .SetHeader("foo", "bar").Build();
            IMessage<int> message2 = MessageBuilder<int>.FromMessage(message1)
                .RemoveHeader("foo")
                .Build();
        ...
        {
            IMessage<string> original = MessageBuilder<string>.WithPayload("foo").Build();
            IMessage<string> result = MessageBuilder<string>.FromMessage(original).Build();
        ...
        {
            IMessage<string> original = MessageBuilder<string>.WithPayload("foo").SetHeader("bar", 42).Build();
            IMessage<string> result = MessageBuilder<string>.FromMessage(original).Build();
            Assert.Equal(original, result);
        }
        ...
        {
            IMessage<string> original = MessageBuilder<string>.WithPayload("foo").SetHeader("bar", 42).Build();
            IMessage<string> result = MessageBuilder<string>.FromMessage(original).SetHeader("bar", 42).Build();
            Assert.Equal(original, result);
        }
        ...
        public void TestCopySameHeaderValuesNotModifiedSameIMessage()
        {
            ...
            IMessage<string> original = MessageBuilder<string>.WithPayload("foo").SetHeader("a", 123).CopyHeaders(originalHeaders).Build();
            ...
            IMessage<string> result = MessageBuilder<string>.FromMessage(original).CopyHeaders(newHeaders).Build();
            Assert.Equal(original, result);
        }
        ...
        public void TestBuildIMessageWithDefaultMutability()
        {
            MessageHeaderAccessor accessor = new MessageHeaderAccessor();
            IMessageHeaders headers = accessor.MessageHeaders;
            IMessage<string> message = MessageBuilder<string>.CreateMessage("foo", headers);
        ...
        public void TestBuildIMessageWithoutIdAndTimestamp()
        {
            ...
            IMessage<string> message = MessageBuilder<string>.CreateMessage("foo", headerAccessor.MessageHeaders);
