...
{
    public class DefaultPollableMessageSource : IPollableMessageSource
    {
        ...
        public DefaultPollableMessageSource(ISmartMessageConverter messageConverter)
        {
        ...
        public bool Poll(IMessageHandler handler)
        {
