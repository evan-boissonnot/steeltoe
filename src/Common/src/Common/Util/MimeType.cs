...
namespace Steeltoe.Common.Util
{
    public class MimeType : IComparable<MimeType>
    {
        ...
        public bool EqualsTypeAndSubtype(MimeType other)
        {
            ...
            return this.type.Equals(other.type, StringComparison.InvariantCultureIgnoreCase) && this.subtype.Equals(other.subtype, StringComparison.InvariantCultureIgnoreCase);
        }
